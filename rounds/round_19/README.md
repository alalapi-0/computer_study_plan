...
1. 打开 `http://127.0.0.1:8777/progress.html?round=round_19`。
2. 依次展开 Week 1 / Week 2 / Week 3 的阅读任务，直接在页面阅读 notes。
3. 点击每周“练习”任务的“运行脚本”，系统会在 `~/cli-lab/round19` 下生成代码、样例数据和静态检查报告，并自动记录该练习任务完成。
4. 点击每周“自测”任务的“终端练习”，在浏览器映射终端中手写一个小脚本，确认自己能解释核心概念；自测完成后点击“记录并完成”保存记录。
5. 最终运行 `r19-fin-comp`，再阅读并点击“记录并完成”保存小抄和验收任务。
