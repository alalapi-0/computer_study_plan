...
| 模块代码 | 模块名 | 与 408 关系 | 推荐优先级 | 笔记骨架文件（按需建） |
|---|---|---|---|---|
| `composition` | 计算机组成基础 | 软考浅，408 深 | P0 | `composition.md` |
| `os` | 操作系统 | 软考广，408 计算题深 | P0 | `os.md` |
| `ds` | 数据结构 | 软考广，408 综合题深 | P0 | `ds.md` |
| `db` | 数据库 | 仅软考考 | P0 | `db.md` |
| `network` | 计算机网络 | 软考广，408 计算题深 | P0 | `network.md` |
| `se` | 软件工程 | 仅软考考 | P0 | `se.md` |
| `uml` | UML / 设计模式 | 仅软考考 | P0 | `uml.md` |
| `oo` | 面向对象 | 仅软考考 | P0 | `oo.md` |
| `security` | 信息安全 | 仅软考考 | P0 | `security.md` |
| `standards` | 标准化与知识产权 | 仅软考考 | P1 | `standards.md` |
| `c_lang` | 程序设计语言（C） | 软考主语言 / 408 表达语言 | P0 | `c_lang.md` |
| `english` | 英语阅读理解 | 仅软考考 | P1 | `english.md` |

> 上表 12 个文件**都不预先创建**。请按真实学习节奏在需要时新建。
